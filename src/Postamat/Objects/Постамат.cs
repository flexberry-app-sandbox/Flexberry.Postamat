...
namespace IIS.Postamat
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat.Статусы fСтатус;
        ...
        /// ID.
        /// </summary>
        // *** Start programmer edit section *** (Постамат.ID CustomAttributes)

        // *** End programmer edit section *** (Постамат.ID CustomAttributes)
        public virtual int ID
        {
            get
            {
                // *** Start programmer edit section *** (Постамат.ID Get start)

                // *** End programmer edit section *** (Постамат.ID Get start)
                int result = this.fID;
                // *** Start programmer edit section *** (Постамат.ID Get end)

                // *** End programmer edit section *** (Постамат.ID Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Постамат.ID Set start)

                // *** End programmer edit section *** (Постамат.ID Set start)
                this.fID = value;
                // *** Start programmer edit section *** (Постамат.ID Set end)

                // *** End programmer edit section *** (Постамат.ID Set end)
            }
        }
        ...
        public virtual IIS.Postamat.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat.Статусы result = this.fСтатус;
